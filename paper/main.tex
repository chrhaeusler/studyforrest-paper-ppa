...
\todo[inline]{imo it should be possible to handle the following two subsections
    in one subsection; à la: GLM + naturalistic stimuli works because
    confounds average (most often) out AND negative control contrasts show
    negative results; except where features of AV + AD were correlated; but
that's actually cool because -> hypothesis}
...
already be mentioned in discussion of primary contrasts}
...
\todo[inline]{concluding statement: essentially "natural stimuli, fuck yeah!;
re-use of existent data; using [and extending] an already existing annotation
for to operationalize a specific perceptual process}
