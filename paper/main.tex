...
\begin{itemize}
    ...
    \item add counts of intro, results, discussion respectively
\end{itemize}
...
\begin{itemize}
    \item kürzen (war nicht ganz einfach)
...
The categories of nouns cueing a setting that occurred for the first time
...
yes, I know it is kinda difficult, figures will be honed at the very end}
...
corrected) can be found in the accompanying dataset. \todo{Neurovault does not
like unstandardized spaces}
...
Results of the primary AD contrast yielded statically significant bilateral
...
\todo[inline]{I tried to keep it concise but detailed; if individual contrasts
are mentioned (enumerated at the moment)}
...
significant clusters also in the ventral precuneal cortex / posterior cingulate
gyrus (i.e. restrosplenial region; contrasts 1, 4, 5) and lateral occipital
cortex (contrasts 1, 2, 4, 5)
% AD; LOC: AV cluster are more medial, AD clusters are more lateral
Reliably across the five contrasts of the AD stimulus, we find bilaterally
significant clusters in the ventral precuneus (all except contrasts 8), lateral
occipital cortex (bilateral in 4 contrasts 1 to 4, unilateral in contrasts 6 and
7), and superior temporal cortices (bilateral in contrasts 3, 6, 7; unilateral
right in contrast 2).
% non-systematic
Contrast 2 also shows bilateral clusters in the anterior cingulate gyrus and
right paracingulate gyrus (frontal medial cortex), right putamen, and right
frontal pole.
%
Contrast 3 shows clusters bilaterally in the anterior cingulate gyrus and
left frontal pole.
%
Contrast 6 shows one additional cluster also in the right medial frontal cortex.
...
one cluster in the right posterior hippocampus. \todo{dorsally of PPA}
...
Compare Figure \ref{fig:reg-corr}: nouns that cue change to a new
