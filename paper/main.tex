...
modeled as impulse events.\todo{actually, it was a box car of 200 ms after
...
expected and served as a ``sanity check'' since the audio-track of the
...
\paragraph{PPA Contrasts} \todo{maybe repeat key questions (cf. intro) here}

% intro
To test the robustness of our approach, we then operationalized the
...
events that trigger perception of space versus e.g. objects or
faces.
