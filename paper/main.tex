...
preceding paragraph; COH: imo the last two paragraphs are about exactly
that??}
...
\todo[inline]{mir das Potential (warum ist das relevant -> rich stimulus ie many
possible analyses, better compliance, easier to perform for difficult
populations, etc) eigentlich zu kurz}
