...
A preliminary annotation by one person according to the rules [entweder im laufenden Text oder in einer [eigenständigen] Tabelle]. Minor corrections due to incorrectly applied rules were by the author.
...
\midrule
body & XY & rBodyAll & rBodyI & rBodyII & rBodyIII & rBodyIV & rBodyV & rBodyVI & rBodyVII & rBodyVIII \tabularnewline
