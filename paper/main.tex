...
\end{abstract}
% Vorgabe: Intro + Discussion = main text ~ 3,000 words.
...
% Retrosplenial Cortex kommt in Einleitung nicht vor
% wird aufgrund der Ergebnisse AV und AO in Discussion diskutiert werden
% -> in den geplanten Abbildungen / Slices aber nicht zu sehen
...
% Egal, was ich folgend in der Überblick & später im Detail bzgl. Aziz (2008) schreibe, es wird wahrscheinlich nicht korrekt sein.
% So wie ich es verstanden habe, hat Aziz den Unterschied zwischen PPA und FFA abgeguckt, aber diesen Unterschied im Kontrast zu object-related Sentences
% Fig 3 dort; im Grunde kommt da aber überall nur uneinheitliche Grütze raus
...
% Review von Aminoff (2013) kommt nur kurz als "competing hypothesis"
% muss man dann natürlich in der Discussion diskutieren,
% was aber ggf. gar nicht notwendig ist, weil's darum gar bei uns gar nicht geht
...
% Coolnessfaktor von naturalistic stimuli ist beinahe komplett raus
% Data-driven vs. theory-driven analyses ist komplett raus
% ggf. erwähnen, dass möglichst ähnliche und nicht fancy analysis gewählt wurde, um Replizierung der Ergebnisse, aber mit naturalistic stimuli zu gewährleisten.
% -> vgl. Speech-Anno-Paper; in Discussion bringen
...
\todo[inline]{
    The next paragraphs contain a bunch of methods already; reduce this to talk about the general approach:
    annotation of events,
    investigation of model quality,
    cross-analysis of datasets.
    Possibly cite https://psyarxiv.com/sdbqv/
