...
\item confound regressors von modeling hoch zu eventes

\item revise captions of Table 1 + 3
...
\paragraph{AV confounds}

% visual confounds -> cf. table

% audio-track confounds
...
\todo[inline]{SE: Continuous bins lasting 40ms?}
...
Lastly, some noun categories that were semantically similar and offered only a
...
\paragraph{AD confounds}

% audio confounds -> cf. AV & table

% final reference to table
