...
% title has to be < 110 chars incl. spaces at the moment 109 Chars
\title{A matter of operationalization: Paradigm and stimulus [feature] selection
impacts localization of "parahippocampal place area"}
...
the audio-description of the same movie (studyforrest.org).
% auditory localizer?
Focussing on the audio-description, we further test if an auditory narrative
could substitute localize a ``visual area'' in individual subjects.
% GLM
