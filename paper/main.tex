...
We co-registered the subjects in two
ways.
...
% MNI152
This reference image was co-registered to the MNI 152 template with an
...
\todo[inline]{at the moment I tend to reporting the stability of contrast first,
and then go on to report the primary contrasts for group and individuals; both
has pros and cons}
...
\begin{figure*} \centering
    ...
    \caption{Stability of contrasts. Overlap of significant clusters (Z>3.4;
        ...
        overlaid on the MNI152 T1-weighted head template (gray).
...
% intro
\todo{intro sentence regarding the primary contrasts}
...
that's what the Harvard-Oxford Atlas suggests, cluster is at borders of the
areas}.
% LOC
...
the level of individual subjects. \todo{maybe report reason here, too: which
subjects influence the group results the most? ``multiple localizer''?}
...
lobes (gray) using the (probabilistic) Jülich Histological Atlas
...
\todo[inline]{the plots are ``biased'' in the PPA mask in such a way that they
don't take into account that clusters are not 100 perc. congruent, meaning the
AO stimulus has voxels in regions that are outside of the individual PPA ->
probably bias to show higher values for the dedicated localizer (red voxels)}
