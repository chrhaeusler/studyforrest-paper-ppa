...
wird gar nicht berichtet, wäre aber wichtig zum Andocken an Literatur}
...
sagen: bei FFA/PPA etc sind flatmaps/inflated brains standard}

\todo[inline]{SE: overlap of clusters/contrasts: Anzahl der Überlappungen ist
schwer abzulesen; lieber eine andere Farbskala (spectral sequence?) nutzen}
...
\todo[inline]{SE: Wie sehen die Antworten innerhalb der "klassisch definierten" PPA für die verschiedenen regressoren bzw. kategorien derselben (zumindest aber places vs faces) aus?}

\todo[inline]{individual results: AO trifft besser die VIS-PPA "trifft" als AV. Das ist zumindest sehr überraschend, oder?}
...
results of the primary contrasts can be found at
