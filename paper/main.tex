...
% AV
Reliably across the five contrasts of the AV stimulus, we also find bilaterally
significant clusters also in the precuneal cortex (contrasts 1, 3, 4; all
bilateral)\todo{and? -> fsleyes} and lateral occipital cortex (all contrasts
except contrast 3)
% AD; LOC: AV cluster are more medial, AD clusters are more lateral
Reliably across the five contrasts of the AD, we find bilaterally significant
clusters in the ventral precuneus (7 contrasts), lateral occipital cortex
(bilateral in 4 contrasts, unilateral in 2 contrasts), superior temporal
cortices (4 contrasts)\todo{uni/bilateral?}.
%
\todo[inline]{(smallish) prefrontal clusters: 3 contrasts (non-overlapping)}
