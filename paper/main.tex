...
cuts and depicted locations \citep{haeusler2016cutanno} in the audio-visual
movie ``Forrest Gump'', while
% AD stimulus
the operationalization of non-visual spatial perception is based on an
annotation of speech \citep{hausler2021studyforrest} occurring in the movie's
audio-description.
% GLM contrasts
