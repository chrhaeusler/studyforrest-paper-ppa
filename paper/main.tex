...
\todo[inline]{shorten the shortcoming; focus on ``opportunities'' for future research}
...
% future studies
Hence, future studies might investigate if a homogeneous category of wholistic
but vague verbal descriptions (e.g. ``a mountain landscape'') compared to a
homogeneous categories of more specific verbal descriptions of landmarks (e.g.
...
of localizer}
%
Based on the fact that the annotation of speech still offered a more precise way
to operationalize the perception of spatial information then the annotation of
cuts and locations, we also hypothesized that data from the audio-description
could reveal the location of the PPA in individual persons.
%
To test if a auditory narrative could [in principle] substitute a visual
localizer experiment, we examined the individual results from the
audio-description's primary contrast.
...
the group level is not just a by-product of the averaging process but can
reliably be found in individual study participants.
% conclusion
...
\todo[inline]{probably not really important but: what do results suggest
...
\todo[inlince]{concluding statement: essentially "natural stimuli, fuck yeah!;
