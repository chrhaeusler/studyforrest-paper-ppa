...
%
Here, we operationalized the perception of spatial information based on
annotated stimulus features embedded in two naturalistic stimuli and compared
current results to results gained from a traditional visual localizer.
%


Here, we reused three fMRI datasets and two stimulus annotations that are part
of the studyforrest dataset \href{http://www.studyforrest.org}{studyforrest.org}
to operationalize the perception of spatial information embedded in two
naturalistic stimuli and to compare current results to results gained from a
traditional visual localizer paradigm.
