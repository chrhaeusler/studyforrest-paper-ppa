...
% intro
For the AO stimulus, we created eight $t$-contrasts that aimed to isolate the PPA and five contrasts for negative control purposes (see Table \ref{tab:ao-contrasts}).
% PPA contrasts
\todo[inline]{settin-related regressors have small event count compared to
geo/groom; probably more importan in discussion}
...
the PPA.
Discussion der Kontraste/Ergebnisse).
...
\todo[inline]{Why done this way? Why is no. 1 the one?}
% intro
For the AV stimulus, we created five contrasts presumably correlating with
increased hemodynamic activity in the PPA by contrasting different kind of cuts.
and five contrasts for negative control purposes.
...
For subsequent second level results, we co-registered the subjects in two ways.
