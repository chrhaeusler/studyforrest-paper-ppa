...
% intro
We used data from three publicly available datasets, all being part of the
...
questions.
% used studies
\todo{this is just loveless listing so far but it's 'complete'}
...
\todo[inline]{why naturalistic stimuli are so cool: sinkusare2019,
    eickhoff2020}
\todo[inline]{model-driven vs. data-driven analyses}
