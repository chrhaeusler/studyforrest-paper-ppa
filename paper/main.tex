...
In this study, we explore different ways to operationalize spatial perception in
...
% auditory localizer?
Focussing on the audio-description, we further test if an auditory narrative
...
general linear model (GLM) $t$-contrasts that are based on stimulus annotations
...
% results: group AV
On a group level, results of our current approach to operationalize the
perception of space during a movie reveal significantly increased hemodynamic
activity spatially overlapping with the PPA but also extending into early visual
cortices.
% results: group AD
Results of the audio-description reveal significant activation restricted to the
