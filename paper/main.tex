...
Previous studies suggest that posterior and anterior part of the PPA show both a
difference in connectivity profiles \citep{baldassano2013differential} and a
gradient in sensitivity to scene and abstract object stimuli
\citep{arcaro2009retinotopic, aminoff2007parahippocampal,
baldassano2013differential}.
% high level summary: posterior

\paragraph{posterior: connectivity \& object sensitivity}

% Baldassano (2013): Our description of posterior PPA is in fact similar to the
% original proposal of Aguirre et al. for a “lingual landmark area” (LLA),
% slightly posterior to PPA, which was “specialized for the perception of visual
% stimuli with orienting value” (Aguirre et al., 1998) and carried out bottom-up
% perceptual analysis to recognize locations or landmarks (Cant and Goodale,
% 2007; Epstein et al., 1999). Although the LLA is no longer identified as an
% independent region from PPA in current studies, it is possible that the
% posterior portion of PPA corresponds to the properties of the proposed LLA,
% offering an explanation for why this region was localized more posteriorly
% than the full PPA.

% connectivity
The posterior PPA is more functionally connected to the occipital visual cortex,
...
visual textures and (abstract) objects \citep{arcaro2009retinotopic,
baldassano2013differential}.
%
The posterior portion of PPA responded about four times as strongly to a
flickering checker-board stimulus compared to an anterior portion, and that the
response to objects was greater than the response to scrambled images only in
the posterior portion => posterior PPA may be more visually responsive than
anterior PPA \citep{arcaro2009retinotopic}.
% in summary: posterior
In summary, the posterior PPA is more concerned with perception of low-level
visual features and object shape.


\paragraph{anterior: connectivity \& (non) contextual sensitivity}

The anterior PPA is more functionally connected to the RSC and parietal cortices
(caudal inferior parietal lobe; cIPL)[, medial PFC, and the lateral surface of
the anterior temporal lobe] \citep{baldassano2013differential}.
% default mode network
[anterior PPA is also more strongly connected to regions in the default mode
...
and the superior frontal cortex) \citep{baldassano2013differential}.
% DMN and contextual association
DMN has been implicated in a large number of internally-focused tasks, one of
its key roles involves autobiographical memory (Buckner et al., 2008).  Models
of recognition memory have previously identified parahippocampal cortex as
primarily encoding spatial context information (Eichenbaum et al., 2007)
\citep{baldassano2013differential}.
% Baldassano regarding Aminoff
Data from \citep{aminoff2007parahippocampal} has suggested that an anterior
portion of PPA may be involved in recall based on spatial context
\citep{baldassano2013differential}.
%
Given anterior PPA's connectivity with the DMN.Our results are consistent with
anterior PPA playing a more central role in memory than posterior PPA
\citep{baldassano2013differential}.

% object sensitivity
The anterior PPA is less visually responsive to both scenes and objects, with
notably low sensitivity to abstract object stimuli, and more involved in memory
and global contextual processing \todo{quotes???}
%
...
\todo[inline]{re-read Baldassano (2013)}
...
% Aminoff
\citep{aminoff2013role} in general (s. also \citep{aminoff2007parahippocampal}:
...
[2,3,59–67].
% Aminoff: contextual associations in anterior vs. posterior
\citep{aminoff2007parahippocampal} propose that a subregion of the posterior PHC
is particularly optimized to process spatially organized contextual
associations, whereas more anterior regions of the PHC are optimized to process
contextual associations in other, non-spatial domains.
...
\citep{aminoff2007parahippocampal}: We compared contextual processing of objects
that are strongly related to a specific place (e.g., an oven is found in a
kitchen) with contextual processing of objects that are highly associated with a
context but not a specific place (e.g., a birthday cake is found at a birthday
...
% results 2
\citep{aminoff2007parahippocampal} Activity within the PHC, however, was
...
% Baldassano (2013): PPA subregions
...
activate selectively to scenes, implying that these subregions cooperate to
build a complete representation of a scene [that sentence is taken from
\citep{baldassano2013differential}].
% Baldassano (2013): conclusion
...
\todo[inline]{e.g. Bettencourt (2013). The Role of Transverse Occipital Sulcus
    ...
    Causally and Selectively Involved in Scene Perception; Grill-Spector (2003).
    The neural basis of object perception; Nakamura (2000). Functional
    delineation of the human occipito-temporal areas; Nasr (2011).
    Scene-selective cortical regions in human and nonhuman primates; Hasson
    (2003). Large-scale mirror-symmetry organization; MacEvoy and Epstein
    (2007). Position selectivity in scene- and object-responsive\dots; Dilks
(2011). Mirror-image sensitivity and invariance in object \& scene processing}
