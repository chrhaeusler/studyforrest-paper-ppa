...
%\title{Stimulus and paradigm selection impacts localization of "parahippocampal place area" (PPA)}
...
Key finding: We observe brain activation congruent with presumed PPA function
in the (anterior) location of the PPA, based on high-level semantic information
in an auditory stimulus.
