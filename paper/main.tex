...
\ref{fig:stability-slices}.\todo{discuss that contrasts make ``less and less''
sense}
% statement/answer
...
6 contrasts (4 bilat.): transverse occipital sulcus (= OPA?);\todo{check again}
% confounds
...
% to do
\todo[inline]{check regions again for posterior PPA (cf. text/clusters regarding
group results); border of lingual gyrus belongs to PPA}
% RSC
