...
% intro
For the AO stimulus, we created eight $t$-contrasts that aimed to isolate the PPA and five contrasts
for negative control purposes (see Table \ref{tab:ao-contrasts}).
% PPA contrasts
...
the PPA (+ recht geringe Anzahl verglichen mit geo, groom) (<- das kommt eher in
