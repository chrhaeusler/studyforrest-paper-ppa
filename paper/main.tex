...
GIN repository
\href{https://gin.g-node.org/chaeusler/studyforrest-ppa-analysis}{\url{gin.g-node.org/chaeusler/studyforrest-ppa-analysis}} (DOI assignedment pending). 
...
(see Figure~\ref{fig:reg-corr}) showed a moderate correlation among cuts to a setting
...
based on events of the annotated movie cuts (see Table~\ref{tab:contrasts}) in
order to test XYZ.
% results
