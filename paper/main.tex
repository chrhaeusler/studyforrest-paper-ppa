...
stimuli (formore recent example using a bigger set or moving stimuli see
\citep{lescroart2019human, pitcher2019functional}
% block-design & task
...
\todo{why exactly did we do this except "we do not expect (lots of) significant
cluster because negative control?}
%
...
data suggest that XYZ.  \todo{concluding statement}.
