...
employed a naturalistic movie stimuli that were designed for entertainment.
...
%#4
We attempted to find hemodynamic responses to spatial information embedded in
the naturalistic stimuli, capitalizing on conceptually similar, but perceptually
different stimulation events.
% group AV
...
information embedded in a movie or a purely auditory narrative, even though the
results may partially deviate from \cite{sengupta2016extension}, due to
...
\cite{baldassano2013differential} proposes PPA function to be the formation of
a complete scene representation, based on the processing of different aspects
of a visual scene in its subregions.
...
increased hemodynamic activity in the PPA. However, methods and results presented
here differ from this previous study in key aspects.
% diff to Aziz (2008)
...
Moreover, in the visual domain, pictures of landscapes and not pictures of landmarks or
...
%#5
% results
Lastly, the group results of the movie stimulus' primary contrast yielded a large cluster
...
% results
This report offers evidence that a model-driven GLM analysis based on
...
%
Contrast 7 shows clusters in the left frontal pole and left frontal operculum, left insular.
%
...
Our whole brain analysis did not identify systematically occuring clusters pointing
to confounding cognitive processes like attention or eye movements
% AV: null results regarding attention and eye movements
% AD: auditory cortices
Nevertheless, for the audio-description stimulus contrasts that compare verbal
hints of the change of a setting (\texttt{se\_new} or \texttt{se\_old}) to all
non-spatial categories (cf. contrasts 2, 3, 6, 7) show clusters in
...
% possible reason
Activity in such clusters could be correlated with a possible
change of the soundscape when the narrator of the audio-description,
corresponding to a cut in the movie, switches udio-description stimulusto a another setting.
% concluding statement
...
hemispheric cluster extending into the superior parietal cortex).\todo{explanation?}
...
one cluster in the right posterior hippocampus.\todo{explanation?}
