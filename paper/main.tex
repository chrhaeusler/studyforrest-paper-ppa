...
block-designed functional localizer paradigm performed with the same
set of participants \citep{sengupta2016extension, sengupta2016extensiondata}.
% intro to hypo a
...
defined as the PPA by the analysis of the localizer data.
%hypo b: individuals
...
\todo[inline]{the ``method'' of creating the surface plot is written here
because it is just one sentence}
...
Table~\ref{tab:res-ao-group1}, Figure~\ref{fig:grp_ao_av_c1_volsurf} as
volume plots and surface plots).
% overlap with ROI
...
for surface plot; unthresholded $Z$-maps are provided at
\href{https://neurovault.org/collections/KADGMGVZ/}{\url{neurovault.org/collections/KADGMGVZ}}).
% AV
