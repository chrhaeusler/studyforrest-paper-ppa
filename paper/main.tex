...
During the experiment, participants were presented with four block-design runs, with
...
% task
Participants also performed a one-back matching task to keep them attentive.
