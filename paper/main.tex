...
\todo[inline]{studies regarding naturalistic stimuli are dropped (Hasson,
2004: reverse correlation in PPA; Bartels, 2004: FFA and EBA). That should be
okay since we focus on the auditory part which should be clearer now; Hasson /
...
% results
\todo[inline]{following paragraph will be similar to abstract and conclusion}
...
\paragraph{AO: COPEs}
 ...
 \todo[inline]{I wonder whether we should make a general
    point: The construction of contrasts of interests feels "messy". But this is
    a consequence of the inability to filter the stimulus material. That "messy"
    part is usually not obvious from a manuscript.  Here we have a fixed,
complex stimulus, and we have to operationalize our questions with whatever we
have at hand. This is not necessarily exact, and looking at the robustness is a
