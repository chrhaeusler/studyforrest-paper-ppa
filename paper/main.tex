...
\todo[inline]{Nach wie vor recht ausführlich; Reihenfolge der subsections mag
``inkorrekt'' sein.}
...
% used studies
We fMRI data from three different studies. The same subjects were
% AO
a) listening to the audio-description (AO study; \citep{hanke2014audiomovie}) of
the movie ``Forrest Gump'', a dataset already used by \citep{hu2017decoding, nguyen2016integration}.
% AV
...
% VIS
c) participating in a dedicated six-category
block-design visual localizer (VIS study) \citep{sengupta2016extension}, a dataset aready used by \citep{jiahui2019predicting}.
...
=> hier stehen lassen und unter Data erwähnen, dass die nicht benutzt wurde}
% AO study
...
listeners on Swiss public television.  was Germin
% AV study
...
In all both studies, participants received monetary compensation and gave
written informed consent for their participation and for public sharing of all
obtained data in anonymized form. The studies had prior approval by the Ethics
Committee of Otto-von-Guericke University of Magdeburg, Germany.
...
on Swiss public television \citep{ForrestGumpGermanAD}.
...
% AV: grey bars
Black horizontal bars at the top and bottom of stimulus of the AV study were
replaced with medium-gray bars of the same size in order to increase back-
ground illumination for a more pleasant experience.
...
luminance, size of 400 $\times$\unit[400]{px}) from each of six stimulus
...
\todo[inline]{um Hinweis bzgl. AV ergänzen}
...
two \unit[16]{s} blocks per stimulus category in each run, while they also performed a one-back matching task to keep them attentive.
...
\todo[inline]{subject 10 was dropped due to excessive motion: see Hanke 2016}
% data source
