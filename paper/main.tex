...
Figure~\ref{fig:group-slices}, and Supplementary
Figure~\ref{fig:grp_ao_av_c1_surf} for results mapped onto reconstructed
cortical surface).
...
(see Table~\ref{tab:res-ao-group1}, Figure~\ref{fig:group-slices}, and
Supplementary Figure~\ref{fig:grp_ao_av_c1_surf} surface plots).
% overlap with ROI
