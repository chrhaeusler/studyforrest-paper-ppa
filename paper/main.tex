...
\item at the moment "Annotation, Regressors and Contrasts" follows
    "Preprocessing" (right before "Statistical Analysis" as we agreed on); going
        back and forth a couple of times, imo there is no perfect location (at
        least in case we do not split that part into "Annotation" and
        "Regressors \& Contrasts" again.

\item structure of ``Annotation, Regressors \& Contrasts'' !! -> everything has
    pros and cons (at the moment lots of subheading since easier to navigate);
    at the moment I think (again) it makes more sense to mention AD first since
    it is the focus of the movie and the AV serves as, well, what exactly?
...
\subsection{Annotation, regressors, contrasts}
\todo[inline]{why not strip contrasts from this section and call it "Event modeling"?}
...
\todo[inline]{key strategy to address research question -> operationalize
    perception of spatial information in naturalistic stimuli that are
ecologically more valid}
...
temporal structure of embedded stimulus features is unknown.\todo{phrasing}
% annotation ftw
...
\subsubsection{Annotations \& regressors}
\todo[inline]{maybe call this "annotation" and put 'Audio-description: annotation' and 'movie: annotation' in it together, and have a subsequent section "event models"}
...
To create the regressor for the GLM of the AD stimulus, some of the original 18
categories that were similar but offered only a small amount of counts were
pooled resulting in eleven new categories [that served as experimental
conditionso] (see Table \ref{tab:ao-events}).
...
viewer within the environment of the movie by either by changing the perspective
...
\todo[inline]{this should likely move into statistical analysis, and be resolved as an individual section}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\todo[inline]{I am currently stuck here}
