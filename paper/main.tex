...
\todo[inline]{Goodale and Milner (1992), which is literally a call for what and
    how pathways. The function of these pathways remains in dispute but its
    clear that where (spatial processing) must take place in both streams. You
