...
% but
Nevertheless, results suggest that localization performance depends on the
...
% BUT: amount of data
Nevertheless, localization performance is influenced on the amount of available
data\todo{give examples of contrast using less events in AV and AO} and well
...
% AO: number of events
\todo[inline]{Number of events in which contrasts?}
% example for data amount AO: superior temporal cortex
In four of nine contrasts of the AO stimulus, we find significant
