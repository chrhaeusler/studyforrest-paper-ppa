...
\texttt{all non-geo} = body, bodypart, fahead, object, sex\_f, sex\_m). Contrast
1-8 aim to isolate the PPA.
Contrast 9-13 serve as negative control at the moments of movie cuts
with possible changes of the audio tracks soundscape (see Table \ref{tab:av-contrasts}}
...
\paragraph{second level (+ alignment)}
...
For the subsequent second level results, we co-registered the subjects in two ways.
...
% model
The third level analysis which averaged contrast estimates over subjects were
...
\begin{figure*} \centering
    ...
    \caption{stability of contrasts}
...
% Unterschiedliche Qualität der Kontrast
% Warum wurde Kontrast 1 als Kontrast 1 gewählt; se\_new se\_old sind recht
% vague in der Beschreibung der Szene verglichen mit Bild; Anzahl der Events
% ergibt auch noch Sinn;
