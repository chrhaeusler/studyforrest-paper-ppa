...
\todo[inline]{following is one exemplary sentence that would benefit from also
mentioning that clusters should not be all over the brain which could be the
case because naturalistic paradigm / confounding variables etc.}
...
% what we did We
annotated a \unit[2]{h} movie and its temporally aligned audio-description to
...
results of the primary $t$-contrasts can be found at
...
completeness. Shall results be reported (and later discussed)?}
