...
cuts and depicted locations in the audio-visual movie ``Forrest Gump'', while
% AD stimulus
non-visual spatial perception is investigated using an annotation of spatial
references in the speech occurring in the movie's audio-description.
% GLM contrasts
