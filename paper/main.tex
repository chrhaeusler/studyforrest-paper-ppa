...
individual subjects.
%
Focussing on the AD stimulus, wee hypothesize[d] that an exclusively auditory
stimulus can/could localize ``visual area'' in individual subjects and thus
possibly substitute a paradigm using blocks of pictures.
% AD results in
...
and AV $t$-contrast, and the outline of overlapped, individual PPAs
\citep{sengupta2016extension}.
% MNI space
...
[parahippocampal] clusters in 12 of 14 subjects and a unilateral right clusters
...
% current analyses: one contrast to localize them all
In the current analyses, we use same contrast of each naturalistic stimulus for
all subjects
...
\subsection{Robustness of PPA across contrasts}
