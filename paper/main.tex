...
non-visual stimulation are less clear \citep{aziz2008modulation}.
...
shots and only later focus more on detailed depictions of people and objects
\citep{brown2012cinematography, mercado2011filmmakers}.
% hypo
We hypothesized that due to the complex nature of a naturalistic stimulus,
...
% group AV
On a group-average level, results for the audio-visual movie show
significantly increased hemodynamic activity spatially overlapping with a
conventionally localized PPA, but also extending into earlier visual cortices.
% group AD
Likewise, results for the audio-description identify significant activation in the PPA
but restricted to its anterior part.
% individual level
Moroever, the group averages are representative for the majority of individual
results, where, for example, the audio-description stimulus yields
...
These findings suggest that increased activation in the PPA during the perception of
static pictures generalizes to the perception of spatial information embedded in
a movie or a purely auditory narrative.
% narrative as substitute
The presented evidence on the in-principle suitability of an auditory-only paradigm
for localizing the PPA, may offer a path to the development of diagnostic procedures
more suitable for populations of individuals with visual impairments or conditions
like nystagmus.
% meaning: aPPA vs. pPPA
Our results provide further evidence that the PPA can be divided into functional
subregions.\todo{what is the other evidence?}
...
In this study, we modeled events from onset to offset of single words and performed a
...
auditory (and visual) information that makes it unlikely that participants
speculate on the purpose of the investigation or perform undesired and unknown
