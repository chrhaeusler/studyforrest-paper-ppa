...
% annotation ftw
Hence, we annotated the temporal structure of a various stimulus features that
...
%
\todo{drop last sentence \& better focus on cinematographic rationale; activity
in e.g. FFA adopts too -> we might subtract an on average smaller response}
