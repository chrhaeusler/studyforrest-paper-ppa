...
important in context of the contrasts; in any case: "cinematographic rationale" is now mentioned first,
then the categories are listed}
...
\todo[inline]{SE: "vse, vno, vpe,..." are not really the most intuitive regressor names -> ausschreiben, wo möglich}
