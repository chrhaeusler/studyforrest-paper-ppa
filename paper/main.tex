...
% AO annotation
For the analysis of the AO data, we extended a publicly available annotation of
...
zwischen zwei Gesichtern sein?!?; COH: that should be clearer now as the
explanation of the regressors immediately follows the description of the
annotation}
