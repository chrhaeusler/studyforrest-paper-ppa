...
for reviews).\todo{but: Aminoff also reviews episodic memory function \&
(theories unifying) contextual info which is not review in intro}
...
preceding paragraph; COH: but imo the hole paragraph is about exactly that??}
...
We assigned each cut to one of five categories (Tab.~\ref{tab:events}):
%
...
\begin{table*}[tbp]
    ...
    Some of the noun categories (female, females, fname; male,
