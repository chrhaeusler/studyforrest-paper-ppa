...
\begin{itemize}
    \item allgemein kürzen; insb. individual results kürzen
    \item consistencies across contrasts ausformulieren
    \item control contrasts ausformulieren
...
\noindent Discussion
\begin{itemize}
    \item umstrukturieren \& ggf. schon kürzen gemäß neuer Schwerpunktsetzung
    \item umschreiben gemäß neuer Schwerpunktsetzung
...
\subsubsection{Events related to low-level perception / perceptual confounds}

\todo[inline]{das Verschieben des Sounds in den Segmenten spiegelt sich auch in
den unterschiedlichen Counts der Events je Segment wider (AV Bild vs AV Sound vs
AO Sound)}
...
We tested our modeled hemodynamic responses by conducting standard
...
On the first level, we created GLM contrasts like studies that contrasted
blocks of pictures.
% dissimilar
But unlike previous studies, our approach was to contrast selected stimulus features that we annotated in the audio-visual movie and its audio-description.
% intro
...
a) [time series were aligned to] via linear transformation to a
subject-specific, study-specific T2* template (cf.
\citep{sengupta2016extension}) and,
