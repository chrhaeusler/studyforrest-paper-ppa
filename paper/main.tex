...
shots (\texttt{no\_cut} category) with movie cut related categories (Tab.~\ref{tab:av-contrasts}).
%
...
based on events of the annotated movie cuts (Tab.~\ref{tab:ao-contrasts}) in
order to test XYZ.
