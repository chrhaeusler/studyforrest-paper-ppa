...
\begin{itemize}
    ...
    \item cf. other Scienctific Data analysis paper
\end{itemize}
...
RSC) and lateral occipital cortex (LOC; more lateral in the AV stimulus, more
medial in the AD stimulus) across contrasts of both naturalistic stimuli.
% RSC intro
...
\todo[inline]{(2nd part of) following paragraph pretty similar to discussion's
first paragraph}
% natural stimulation
...
functional subregions that [might] work together during the perception of visual
scenes.
% interpretation
...
subjects who are not [willing or] able to follow task instructions during brain
scanning.
...
\todo[inline]{Figures \& Tables have their own section, the editor puts them
where he wants them?}
...
% Discussion
The results across the contrasts of the AV and AD stimulus indicate that our
...
\todo[inline]{random [?] prefrontal cluster in 2-3 AO contrasts; at the moment
