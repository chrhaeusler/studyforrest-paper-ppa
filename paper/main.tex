...
PHC can be thought of as processing of contextual associations.
%
A subregion of the posterior PHC is particularly optimized to process spatially
organized contextual associations, whereas more anterior regions of the PHC are
optimized to process contextual associations in other, non-spatial domains.
...
PPA; Epstein, 1998).
%
We do not argue that the PHC is not sensitive to spaces,
...
contexts (e.g., a lamp).
% results
Differential activity was found in the PHC and the RSC,
