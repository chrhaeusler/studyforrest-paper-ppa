...
We assigned each cut to one of five categories (see Table
\ref{tab:av-events}):
%
...
also across both stimuli (Figure \ref{fig:reg-corr}).
...
the movie plus the additional narrator (s. Figure \ref{fig:reg-corr}).
...
participants and an unilateral right clusters in two participants (cf. Table 3 in
\citep{sengupta2016extension}).
% Sengupta: 1 of 3
...
participant (see Figure \ref{fig:bland-altman}).
% what it depicts
