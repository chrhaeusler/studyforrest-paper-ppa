...
%
\citep{baumann2016functional} paradigm: We measure parahippocampal responses
while participants engaged in a task that required them to judge the contextual
...
%
Results: aPHC is more active during contextual
judgments regardless of stimulus category (scenes vs objects) or modality (word
vs picture).
%
