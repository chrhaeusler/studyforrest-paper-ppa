...
\subsection{Additional contrasts: let's talk about left overs}

\todo[inline]{look at the events within categories \& give some counts}

\todo[inline]{compare with Michaels make over of text regarding confound
structure

\todo[inline]{main message here again: you need events! (and be aware of biases)}

%
Three contrasts yielded bilaterally significant clusters in superior temporal
cortices (contrasts 3, 6, 7), one contrast a unilateral right cluster (contrast
2).
%
\todo{following is (probably too) exhaustive}
%
...
Conclusion: This can be attributed to the uncontrolled nature of averaged events.
