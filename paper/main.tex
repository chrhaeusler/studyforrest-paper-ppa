...
already, so here in the text stability of contrast is still reported first}
...
that's what the Harvard-Oxford Atlas suggests, clusterss are at borders of the
areas}.
% precuneus
...
\todo[inlin]{concluding statement for the paragraph}
...
Individual differences when seeing a whole picture with many features vs. stream
of serial auditory information providing incidential cues; spatial attention?
\todo[inlin]{which contrast works better in which subjects?}
