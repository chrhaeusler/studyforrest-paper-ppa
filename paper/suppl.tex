...
verwirrend}
\todo[inline]{table of contents not necessary (?) but table of figures; see
    Guidelines: ``A table of contens should be included on the first page,
    listing the page number of each supplementary figure``}
...
\subsection*{Surface plots of individual results}
