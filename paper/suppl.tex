...
\todo[inline]{references to Figures/Tables in main.tex are hardcoded;
    cross-referencing only works to the PDF that gets compiled as the second
one?}
...
\citep{hanke2016freesurferdata}.\todo{ref to GitHub ``data-freesurfer''}
% projection
...
audio-description (see Table~5).\todo{hardcoded; cross-ref does not work}
% \ref{tab:contrasts}).
% how
...
% \texttt{vse\_old}.
% \ref{fig:reg-corr})
The correlation of regressors across stimuli (Figure~4)\todo{hardcoded} showed
