...
\todo[inline]{Position der Abbildungen ist im kompilierten PDF maximal
verwirrend}

\todo[inline]{I added table of contents \& figure. s. Guidelines: ``A table of
contens should be included on the first page, listing the page number of each
supplementary figure``}

\todo[inline]{add the references to main manuscript (see ``??'') because
cross-referencing does not work in the pdf that gets compiled first}
...
Figure~\ref{fig:subjs_ao_av_c1_surf} shows the individual results of
...
% smoothing
After projection, individual PPA ROIs were spatially smoothed applying a
...
not averaged out across events and that the employed nuisance regressors did not
capture this variance appropriately.
% possible explanation
The bias of the GLM contrasts towards lower-level auditory perceptual processes
